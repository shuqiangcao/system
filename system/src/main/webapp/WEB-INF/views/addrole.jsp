            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>新增角色</h4>
                        <section id="unseen">
                                ...
                                <div class="panel-body">
                                    <form role="form" action="/user/saveuser" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入角色名称">
                                        </div>
    ...
    function addrole() {
        ...
        $.ajax({
            ...
            success:function (result) {
                if (result.success){
                    layer.msg("新增角色成功！", {time:3000, icon:6, shift:2}, function(){});
                    window.setTimeout("window.location.href='${basePath}/role/rolelist'",2000);
                }else if(!result.repeatUser){
                    layer.msg("角色已存在！", {time:2000, icon:5, shift:6}, function(){});
                }else{
                    layer.msg("新增角色失败！", {time:2000, icon:5, shift:6}, function(){});
                }
            }
        });
