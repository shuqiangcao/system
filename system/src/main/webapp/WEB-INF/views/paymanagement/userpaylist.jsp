					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="10" align="center">
								<ul class="pagination" id="cppaylistpage">
...
<script>
	...
	$("#cppaylistcount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checkpaylist(pageNum) {
		...
		$.ajax({
			type:"POST",
			url:"${basePath}/pay/checkuserpaylist",
			...
			success:function (result) {
				...
				$(".paylistfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='cppaylistpagefoot'></ul><ul id='cppaylistcount'></ul></td></tr>");
				//使用插件分页
				$.jqPaginator('#cppaylistpagefoot', {
				...
				$("#cppaylistcount").append("<span>共"+totalPage+"页"+countNum+"条记录</span>")
			}
		});
	}
	//翻页
