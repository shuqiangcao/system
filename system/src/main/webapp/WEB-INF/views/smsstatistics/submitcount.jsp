					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination" id="submitcountpage">
...
<script>
	...
	$("#submitcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checksubmitcount(pageNum) {
		...
		var cp = $("#submitcountcp").val();
		var channel = $("#submitcountchannel").val();
		var way = $("#submitcountby").val();
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checksubmitcount",
			...
			success:function (result) {
				...
				var byway = $("#submitcountby").find("option:selected").text();
				$("#way").text("");
				$("#way").text(byway);
				//清空表格数据
				...
				//插件分页
				$(".submitcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='checksubmitcountpage'></ul><ul id='checkpagecount'></ul></td></tr>");
				$.jqPaginator('#checksubmitcountpage', {
