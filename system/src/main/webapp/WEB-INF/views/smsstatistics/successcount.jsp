    ...
    *********************************************************************************************************************************************************** -->
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i>统计查询/短信成功量统计</h3>
			<div class="row mt">
				<div class="col-lg-12 col-xs-12">
					<h4><i class="fa fa-angle-right"></i>成功量统计</h4>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control successcountcp" id="successcountcp">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control successcountchannel" id="successcountchannel">
									<option value="" selected>全部</option>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control successcountby" id="successcountby">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 btn-group">
								<button type="button" class="btn btn-warning" onclick="checksuccesscount(1);"><i class="glyphicon glyphicon-search"></i>查询</button>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table  table-bordered">
						...
						<tr >
							...
							<th id="successway">日期</th>
							<th>成功数</th>
						</tr>
						</thead>
						<tbody class="successcountmsg">
						<c:forEach items="${result.data}" var="item" varStatus="status">
							<tr class="successcount_tr">
						...
						<tfoot class="successcountfoot">
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination">
									<ul class="pagination" id="successcountpage">
...
<script>
	...
	$("#successcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function changePageNum(pageNum){
		window.location.href = "${basePath}/statistical/smssuccess?pageNum="+pageNum;
	}

	//条件查询数据
	function checksuccesscount(pageNum) {
		var loadingIndex = null;
		var cp = $("#successcountcp").val();
		var channel = $("#successcountchannel").val();
		var way = $("#successcountby").val();
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checksuccesscount",
			...
			success:function (result) {
				...
				var byway = $("#successcountby").find("option:selected").text();
				$("#successway").text("");
				$("#successway").text(byway);
				//清空表格数据
				$(".successcountmsg").empty();
				$(".successcountfoot").empty();
				//总页码
				...
				for (var i = 0; i < dataStr.length ; i++) {
					$(".successcountmsg").append("<tr class='successcount_tr'>" +
							"<td>"+(i+1)+"</td><td><input type='checkbox' ></td><td>"+dataStr[i].way+"</td><td>"+dataStr[i].successNum+"</td></tr>");
				}
				//插件分页
				$(".successcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='checksuccesscountpage'></ul><ul id='checkpagecount'></ul></td></tr>");
				$.jqPaginator('#checksuccesscountpage', {
