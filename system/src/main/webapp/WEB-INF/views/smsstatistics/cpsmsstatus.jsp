	...
	function checkstatus(pageNum) {
		...
		$.ajax({
			...
			success:function (result) {
				...
				$(".statusfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='statusmsgpage'></ul><ul id='statussmspagecount'></ul></td></tr>");
				//使用插件分页
				...
				$("#statussmspagecount").append("<li><span>共"+totalPage+"页"+countNum+"条记录</span></li>")
			}
		});
	}
