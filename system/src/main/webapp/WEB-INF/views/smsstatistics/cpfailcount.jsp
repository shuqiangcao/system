					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination">
									<ul class="pagination" id="cpfailcountpage">
...
<script>
	...
	$("#cpfailcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checkfailcount(pageNum) {
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checkcpfailcount",
			...
			success:function (result) {
				...
				for (var i = 0; i < dataStr.length ; i++) {
					$(".failcountmsg").append("<tr class='failcount_tr'>" +
							...
							"<td><input type='checkbox' ></td>" +
							"<td>"+dataStr[i].way+"</td>" +
							"<td>"+dataStr[i].failNum+"</td>" +
							"</tr>");
				}
				//插件分页
				$(".failcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='cpcheckfailcountpage'></ul><ul id='cpcheckpagecount'></ul></td></tr>");
				$.jqPaginator('#cpcheckfailcountpage', {
