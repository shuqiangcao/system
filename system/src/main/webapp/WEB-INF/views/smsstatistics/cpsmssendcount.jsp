					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination">
									<ul class="pagination" id="cpsmssendcountpage">
...
<script>
	...
	$.jqPaginator('#cpsmssendcountpage', {
	...
	$("#cpsmssendcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checksmssendcount(pageNum) {
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checkcpsmssendcount",
			...
			success:function (result) {
				...
				//插件分页
				$(".smssendcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='cpchecksmssendcountpage'></ul><ul id='cpcheckpagecount'></ul></td></tr>");
				$.jqPaginator('#cpchecksmssendcountpage', {
