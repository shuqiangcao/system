					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination" id="cpsendcountpage">
...
<script>
	...
	$("#cpsendcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checksendcount(pageNum) {
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checkcpsendcount",
			...
			success:function (result) {
				...
				//插件分页
				$(".sendcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='cpchecksendcountpage'></ul><ul id='cpcheckpagecount'></ul></td></tr>");
				$.jqPaginator('#cpchecksendcountpage', {
