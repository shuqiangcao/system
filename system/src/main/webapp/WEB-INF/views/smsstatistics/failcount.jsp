    ...
    *********************************************************************************************************************************************************** -->
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i>统计查询/短信失败量统计</h3>
			<div class="row mt">
				<div class="col-lg-12 col-xs-12">
					<h4><i class="fa fa-angle-right"></i>失败量统计</h4>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control failcountcp" id="failcountcp">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control failcountchannel" id="failcountchannel">
									<option value="" selected>全部</option>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control failcountby" id="failcountby">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 btn-group">
								<button type="button" class="btn btn-warning" onclick="checkfailcount(1);"><i class="glyphicon glyphicon-search"></i>查询</button>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table  table-bordered">
						...
						<tfoot class="failcountfoot">
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination">
									<ul class="pagination" id="failcountpage">
...
<script>
	...
	$("#failcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function changePageNum(pageNum){
		window.location.href = "${basePath}/statistical/smsfail?pageNum="+pageNum;
	}

	//条件查询数据
	function checkfailcount(pageNum) {
		var loadingIndex = null;
		var cp = $("#failcountcp").val();
		var channel = $("#failcountchannel").val();
		var way = $("#failcountby").val();
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checkfailcount",
			...
			success:function (result) {
				...
				var byway = $("#failcountby").find("option:selected").text();
				$("#failway").text("");
				$("#failway").text(byway);
				//清空表格数据
				$(".failcountmsg").empty();
				...
				for (var i = 0; i < dataStr.length ; i++) {
					$(".failcountmsg").append("<tr class='failcount_tr'>" +
							"<td>"+(i+1)+"</td><td><input type='checkbox' ></td><td>"+dataStr[i].way+"</td><td>"+dataStr[i].failNum+"</td></tr>");
				}
				//插件分页
				$(".failcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='checkfailcountpage'></ul><ul id='checkpagecount'></ul></td></tr>");
				$.jqPaginator('#checkfailcountpage', {
