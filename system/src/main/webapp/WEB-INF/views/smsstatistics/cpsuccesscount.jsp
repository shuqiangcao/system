					...
					<table class="table  table-bordered">
						...
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination">
									<ul class="pagination" id="cpsuccesscountpage">
...
<script>
	...
	$.jqPaginator('#cpsuccesscountpage', {
	...
	$("#cpsuccesscountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function checksuccesscount(pageNum) {
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checkcpsuccesscount",
			...
			success:function (result) {
				...
				for (var i = 0; i < dataStr.length ; i++) {
					$(".successcountmsg").append("<tr class='successcount_tr'>" +
							...
							"<td><input type='checkbox' ></td>" +
							"<td>"+dataStr[i].way+"</td>" +
							"<td>"+dataStr[i].successNum+"</td>" +
							"</tr>");
				}
				//插件分页
				$(".successcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='cpchecksuccesscountpage'></ul><ul id='cpcheckpagecount'></ul></td></tr>");
				$.jqPaginator('#cpchecksuccesscountpage', {
