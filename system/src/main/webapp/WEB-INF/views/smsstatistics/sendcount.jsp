    ...
    *********************************************************************************************************************************************************** -->
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i>统计查询/短信发送量统计</h3>
			<div class="row mt">
				<div class="col-lg-12 col-xs-12">
					<h4><i class="fa fa-angle-right"></i>发送量统计</h4>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control sendcountcp" id="sendcountcp">
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control sendcountchannel" id="sendcountchannel">
									<option value="" selected>全部</option>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 mb">
								...
								<select class="form-control sendcountby" id="sendcountby">
							...
							<div class="col-lg-5 col-md-5 col-sm-5 btn-group">
								<button type="button" class="btn btn-warning" onclick="checksendcount(1);"><i class="glyphicon glyphicon-search"></i>查询</button>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive">
					<table class="table  table-bordered">
						...
						<tfoot class="sendcountfoot">
						<tr >
							<td colspan="12" align="center">
								<ul class="pagination" id="sendcountpage">
...
<script>
	...
	$("#sendcountpagecount").append("<li><span>共"+pagesum+"页"+countnum+"条记录</span></li>")
	...
	function changePageNum(pageNum){
		window.location.href = "${basePath}/statistical/sendstatistical?pageNum="+pageNum;
	}

	//条件查询数据
	function checksendcount(pageNum) {
		var loadingIndex = null;
		var cp = $("#sendcountcp").val();
		var channel = $("#sendcountchannel").val();
		var way = $("#sendcountby").val();
		...
		$.ajax({
			type:"GET",
			url:"${basePath}/statistical/checksendcount",
			...
			success:function (result) {
				...
				var byway = $("#sendcountby").find("option:selected").text();
				$("#way").text("");
				$("#way").text(byway);
				//清空表格数据
				$(".sendcountmsg").empty();
				...
				for (var i = 0; i < dataStr.length ; i++) {
					$(".sendcountmsg").append("<tr class='sendcount_tr'>" +
							"<td>"+(i+1)+"</td><td><input type='checkbox' ></td><td>"+dataStr[i].way+"</td><td>"+dataStr[i].sendNum+"</td></tr>");
				}
				//插件分页
				$(".sendcountfoot").append("<tr><td colspan='12' align='center'><ul class='pagination' id='checksendcountpage'></ul><ul id='checkpagecount'></ul></td></tr>");
				$.jqPaginator('#checksendcountpage', {
