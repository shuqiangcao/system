            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>修改角色</h4>
                        <section id="unseen">
                            <div class="panel panel-default">
                                <div class="panel-heading">表单数据<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"></div></div>
                                <div class="panel-body">
                                    <form role="form" action="/role/saverole" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">角色名称</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1" value="${role.roleName}">
                                        </div>
                                        <button type="button" class="btn btn-success" onclick="updaterole();"><i class="glyphicon glyphicon-plus"></i>修改</button>
...
<script>
    function updaterole() {
        var roleName = $("#exampleInputPassword1").val();
        var loadingIndex = null;
        if(roleName == ""){
            layer.msg("角色名称不能为空，请输入角色名称", {time:2000, icon:5, shift:2}, function(){});
            return;
        }
        //提交表单数据
        $.ajax({
            ...
            data:{"roleName":roleName,"roleId":${param.roleId}},
            beforeSend:function () {
