            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>修改用户</h4>
                        <section id="unseen">
                                ...
                                <div class="panel-body">
                                    <form role="form" action="/user/saveuser" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword2" value="${user.passWord}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">手机号码</label>
                                            <input type="text" class="form-control" id="exampleInputPassword3" value="${user.telePhone}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">公司</label>
                                            <input type="text" class="form-control" id="exampleInputPassword6" value="${user.comp}">
                                        </div>
                                        <div class="form-group">
                                            <label>状态</label>
                                            <input type="statu" class="form-control" id="exampleInputEmail5" value="${user.status}">
                                            <p class="help-block label label-warning">0:正常  1:冻结</p>
                                        </div>
                                        <div class="form-group">
                                            <label>邮箱地址</label>
                                            <input type="email" class="form-control" id="exampleInputEmail4" value="${user.email}">
                                            <p class="help-block label label-warning">请输入合法的邮箱地址, 格式为： xxxx@xxxx.com</p>
                                        </div>
                                        <button type="button" class="btn btn-success" onclick="updateuser();"><i class="glyphicon glyphicon-plus"></i>修改</button>
...
<script>
    function updateuser() {
        ...
        var status = $("#exampleInputEmail5").val();
        var comp = $("#exampleInputPassword6").val();
        ...
        if(status == ""){
            layer.msg("用户状态不能为空，请输入状态", {time:2000, icon:5, shift:2}, function(){});
            return;
        }
        //提交表单数据
        $.ajax({
            ...
            data:{"userName":userName,"pwd":pwd,"mobile":mobile,"email":email,"userId":${param.userId},"status":status,"comp":comp},
            beforeSend:function () {
                loadingIndex =  layer.msg('处理中...', {icon: 16});
            },
            success:function (result) {
                if (result.success){
                    layer.msg("修改用户成功！", {time:3000, icon:6, shift:2}, function(){});
