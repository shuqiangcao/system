            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>长链接批量转短链接</h4>
                        <section id="unseen">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form role="form" action="" method="post">
                                        ...
                                        <button type="button" class="btn btn-success" onclick="batchurl();">生成短链</button>
                                    </form>
                                </div>
                            </div>
                        </section>
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                if (result.success){
                    ...
                    window.setTimeout("window.location.href='${basePath}/url/allbatchurl'",2000);
                }else{
