            ...
            <div class="row mt">
                <div class="col-lg-12 col-xs-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i>权限修改</h4>
                        <section id="unseen">
                                ...
                                <div class="panel-body">
                                    <form role="form" action="/user/saveuser" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword1" value="${permission.name}" placeholder="请输入权限名称">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">链接地址</label>
                                            <input type="text" class="form-control" id="exampleInputPassword2" value="${permission.url}" placeholder="请输入链接地址">
                                        </div>
...
<script>
    function updatepermission() {
        ...
        $.ajax({
            ...
            data:{"name":permissionName,"url":permissionUrl,"id":"${param.id}"},
            beforeSend:function () {
                loadingIndex =  layer.msg('处理中...', {icon: 16});
            },
            success:function (result) {
                if (result.success){
                    layer.msg("权限修改成功！", {time:3000, icon:6, shift:2}, function(){});
                    ...
                    layer.msg("权限修改失败！", {time:2000, icon:5, shift:6}, function(){});
                }
            }
        });
